...
export class CompHomeComponent implements OnInit {
  ...
  toolDescription: string = 'এই সঁজুলিবিধ অসমৰ বিভিন্ন কেন্দ্ৰত টীকা আৰক্ষণ কৰা সহজ কৰি তোলাৰ এক ক্ষুদ্ৰ আৰু নিৰীহ প্ৰয়াস৷ ' +
    'মনত ৰাখিব, এই সঁজুলিবিধে আজিৰ দিনটোৰ পৰা এসপ্তাহলৈকেহে টীকাৰ উপলভ্যতাৰ বিষয়ে তথ্য দিব পাৰে৷ ই প্ৰত্যেক '
